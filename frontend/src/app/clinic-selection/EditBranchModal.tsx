...
import { ERROR_CLASS, LabeledInput, Overlay, PrimaryButton, SecondaryButton } from "./modal-ui";
  ...
  return (
    <Overlay onClose={onClose} labelledBy="edit-branch-title">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <LabeledInput id="edit-branch-contact" label="Contact Number" value={contact} onChange={(v) => { setContact(v); setContactError(""); }} placeholder="+91 followed by 10 digits" error={contactError} />
